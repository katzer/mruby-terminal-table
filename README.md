# mruby-terminal-table <br> [![Build Status](https://travis-ci.com/katzer/mruby-terminal-table.svg?branch=master)](https://travis-ci.com/katzer/mruby-terminal-table)
